...
class DatePickerController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        let leftBarButtonItem = ViewControllerItems.createBarButtonItemWithImage(#selector(self.dismissViewController), frame:CGRect(x: 0, y: 0, width: 25, height: 25), image: UIImage(named: "back_button_64.png")!, target: self)
        let rightBarButtonItem = ViewControllerItems.createBarButtonItemWithImage(#selector(self.cancelDateSelection), frame:CGRect(x: 0, y: 0, width: 40, height: 40), image: UIImage(named: "cancel_button_64.png")!, target: self)
